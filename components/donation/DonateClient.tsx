...
import { DonationTier, SiteConfig } from "@/lib/types";
...
export default function DonateClient({ tiers, config }: DonateClientProps) {
  const [selectedTier, setSelectedTier] = useState<DonationTier | null>(null);

  const handlePayPalClick = (tier: DonationTier) => {
  ...
  return (
    <div className="py-12 md:py-20">
      <div className="container-custom">
        ...
        {/* Tier Grid */}
        <div className="mb-16">
          <TierGrid tiers={tiers} onPayPalClick={handlePayPalClick} />
        </div>

        {/* Donation Form Modal */}
        {selectedTier && (
          <DonationForm tier={selectedTier} onClose={handleCloseForm} />
        )}
